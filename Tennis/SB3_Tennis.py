...
class CustomEvalCallback(BaseCallback):
    def __init__(self, eval_env, eval_freq=1, verbose=1):
...
if __name__ == "__main__":
    ...
    config['export_path'] = f"/fhome/pmlai10/Project_RL/Tennis/{model_name}"
    ...
    # Callbacks
    eval_callback = CustomEvalCallback(eval_env, eval_freq=config['eval_freq'], verbose=2)
