...
class CustomEvalCallback(WandbCallback):
    ...
    def evaluate_policy(self, calls, policy='train'):
        ...
        while not done and t < 10000:
            ...
            combined_image.save(f"{self.export_path}/videos/{self.n_calls}_{t}.png")
...
if __name__ == "__main__":
    ...
    # Callbacks
    eval_callback = CustomEvalCallback(eval_env, export_path = results_dir, eval_freq=10, verbose=2)
